...
export const initialResumeData: ResumeData = {
  ...
  styling: {
    font: { family: 'Helvetica', size: 10, color: '#333333' },
    heading: { family: 'Helvetica', size: 25, color: '#333333' },
    subheading: { family: 'Helvetica', size: 11, color: '#333333' },
    sectionTitle: { family: 'Helvetica', size: 12, color: '#000000' },
  }
};
