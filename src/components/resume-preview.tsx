...
export function ResumePreview({ data, isMobilePreview = false }: ResumePreviewProps) {
  ...
  const previewClass = "w-[210mm] min-h-[297mm] mx-auto bg-card shadow-lg";

  if (!data) {
    return (
      <aside className={asideClass}>
        <div className="w-[210mm] min-h-[297mm] mx-auto bg-card shadow-lg p-8 flex items-center justify-center">
